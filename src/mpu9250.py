...
#        strAcc ="Acc = {:6.2f}, {:6.2f}, {:6.2f}, ".format(accXYZ[0], accXYZ[1], accXYZ[2])
#        strGyro ="Gyro = {:6.2f}, {:6.2f}, {:6.2f}, ".format(gyrXYZ[0], gyrXYZ[1], gyrXYZ[2])
#        strMag ="Mag = {:6.2f}, {:6.2f}, {:6.2f}, ".format(magXYZ[0], magXYZ[1], magXYZ[2])
#        strTemp ="Temp = {:6.2f}".format(temp)
